...
var i = guestList.length;
while (i > 2) {
    var notComingGuest = guestList.pop();
    console.log("Dear ".concat(notComingGuest, ", We're really sorry to say that It's almost impossible for us to meet tonight due to mismanagement of the event.\n"));
    i--;
}
guestList.map(function (guest) { return console.log("Dear Sir ".concat(guest, ", You're invited for the dinner tonight. Thanks for accepting this invitation\n")); });
guestList.pop();
guestList.pop();
